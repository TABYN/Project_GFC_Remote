# Generated by Django 2.2.10 on 2022-12-07 22:41
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('scolar', '0237_mandat_article_mandat'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='mandat',
            name='annee_budget',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='annee_budget', to='scolar.AnneeUniv'),
        ),
        migrations.AddField(
            model_name='mandat',
            name='credit_allou',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='credit_allou', to='scolar.Credit_S2'),
        ),
        migrations.AddField(
            model_name='mandat',
            name='montant_operatio',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, max_digits=9, null=True),
        ),
        migrations.AddField(
            model_name='mandat',
            name='montant_operatio_currency',
